---
title: "Cross-Disease Modeling - Hippocampus PLS-DA"
...
#svg('human_heatmap_filt.svg', width = 4, height = 4)
pheatmap(
...
#svg('PLSDA-human.svg', width = 4, height = 4)
...
selected_words <- c("CXCL10", "COL1A2", "G6PD", "RPS21", "RPS10", "ZNF467", "MBOAT7", "RPL24", "NRGN", "RPL35A", "BCORL1", "ARID1A", "RPL36A", "BNC1", "WDR38", "SLC9A1", "SNRPD2", "POLR2K", "ALB", "ATP6V0C", "NDUFB1", "COX6C", "COX7C", "TNRC18", "CHGA")
...
loadingsAD$Gene <- factor(loadingsAD$Gene,
                  levels = c("CHGA", "TNRC18", "COX7C", "COX6C", "NDUFB1", "ATP6V0C","ALB", "POLR2K", "SNRPD2", "SLC9A1", "WDR38", "BNC1", "RPL36A", "ARID1A", "BCORL1", "RPL35A", "NRGN", "RPL24", "MBOAT7", "ZNF467", "RPS10", "RPS21", "G6PD", "COL1A2", "CXCL10"))
...
#svg('PLSDA-LV1_loadings.svg', width = 4, height = 4)
...
loadingsAD %>%
        ggplot(aes(x = Gene, y = comp1, fill = Gene)) +
            ...
            scale_fill_manual(values = c("royalblue3", "red3", "royalblue3", "royalblue3", "royalblue3", "royalblue3", "red3", "royalblue3", "royalblue3", "red3", "red3", "red3", "royalblue3", "red3", "red3", "royalblue3", "royalblue3", "royalblue3", "royalblue3", "red3", "red3", "royalblue3", "royalblue3", "red3", "red3")) + 
...
# Specify the desired words in the desired order
selected_words <- c("POLR2K", "RPL24", "NRGN", "NDUFB1", "SNRPD2", "ARID1A","ATP6V0C", "MBOAT7", "RPS21", "RPL35A", "COX7C", "ALB", "WDR38", "RPL36A", "G6PD", "TNRC18", "SLC9A1", "RPS10", "COX6C", "CXCL10", "BNC1", "COL1A2", "BCORL1", "ZNF467", "CHGA")
...
# Preparing factor to establish the barplot positioning in the figure across all groups
loadingsAD$Gene <- factor(loadingsAD$Gene,
                  levels = c("CHGA", "ZNF467", "BCORL1", "COL1A2", "BNC1", "CXCL10","COX6C", "RPS10", "SLC9A1", "TNRC18", "G6PD", "RPL36A", "WDR38", "ALB", "COX7C", "RPL35A", "RPS21", "MBOAT7", "ATP6V0C", "ARID1A", "SNRPD2", "NDUFB1", "NRGN", "RPL24", "POLR2K"))

# Plot loadings with each variable identified with highest contribution to a specific class
plotLoadings(plsda_AD, comp = 2, method = 'mean', contrib = 'max')
#svg('PLSDA-LV2_loadings.svg', width = 4, height = 4)
# Plot of loadings color adjusted with fixed cytokine list
loadingsAD %>%
        ggplot(aes(x = Gene, y = comp2, fill = Gene)) +
            geom_bar(stat = "identity", color="black", show.legend = FALSE, width = 1) +
            scale_fill_manual(values = c("royalblue3", "red3", "red3", "red3", "red3", "red3", "royalblue3", "red3", "red3", "red3", "royalblue3", "royalblue3", "red3", "red3", "royalblue3", "royalblue3", "royalblue3", "royalblue3", "royalblue3", "red3", "royalblue3", "royalblue3", "royalblue3", "royalblue3", "royalblue3")) + 
